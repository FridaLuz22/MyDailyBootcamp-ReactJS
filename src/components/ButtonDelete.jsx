...
function ButtonDelete({open,setModalDelete}){
  let buttonDeleteActions=()=>{
    setModalDelete(true)
  }
  return(
    <button className={open?"button-delete":"button-delete visibility-hidden"} onClick={buttonDeleteActions}>
